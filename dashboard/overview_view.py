...
:root {{ --cw-canvas:#0B0F14; --cw-panel:#131A22; --cw-panel-2:#0F141B;
...
def _render_coaching_zone(strengths, weaknesses, sqlite_conn, insights_page, page_refs):
...
def render(self_page, detail_page, *, patterns_page=None, matchups_page=None,
    ...
    _render_coaching_zone(strengths, weaknesses, sqlite_conn, insights_page, page_refs)
